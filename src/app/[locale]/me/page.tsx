          ...
          <section className={styles.heroCard}>
            ...
            <div className={styles.stats}>
              ...
              <div className={styles.stat}>
                ...
                <div className={styles.statHint}>{locale === "dk" ? "På tværs af enheder" : "Across devices"}</div>
              </div>
              <div className={styles.stat}>
                <div className={styles.statLabel}>Guides</div>
                <div className={styles.statValue}>{locale === "dk" ? "In-app" : "In-app"}</div>
                <div className={styles.statHint}>{locale === "dk" ? "Sikkerhed først" : "Safety first"}</div>
              </div>
            </div>
          </section>
        ) : (
          <>
            <section className={styles.heroCard}>
              <div className={styles.heroTop}>
                ...
                <div className={styles.heroActions}>
                  <Link className={styles.secondaryBtn} href={`/${locale}/settings`}>Settings</Link>
                  <Link className={styles.secondaryBtn} href={`/${locale}/ask`}>Ask</Link>
                </div>
              </div>
