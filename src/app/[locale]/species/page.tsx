...
export default async function SpeciesIndexPage({
  ...
  // Fetch species + translation for this locale
  // Note: we query translations separately to avoid "inner join" edge cases
  ...
  const subtitle =
    locale === "dk"
      ? "SEO-hub: find artsprofiler med sæson, identifikation og forvekslinger."
      : "SEO hub: species pages with season, identification and look-alikes.";
